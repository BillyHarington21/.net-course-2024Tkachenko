...
class Programm
{
    static void Main(string[] args)
    {
        ...
        shareholder.Salary = bankService.SalaryBankShareholders();//** вызываем метод для расчета дохода Одного конретного владельца из расчета, что доля у всех акционеров одиннаковая
